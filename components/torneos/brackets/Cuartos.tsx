...
export default function Cuartos({ cuartos }: { cuartos: any[] }) {
  ...
  const handleFinalClick = (pareja: any, posicion: any) => {
    if (posicion === "arriba") {
  ...
  const handleGanadorClick = (pareja: any) => {
          ...
          <div className="relative">
            <div className="w-44 h-12 rounded-md border flex flex-col">
              <div
                ...
                onClick={() => handleClick(cuartos[2].pareja1, "arriba1")}
              >
                <p
                  className={`text-xs text-end p-1 ${
                    parejaSeleccionada1 === cuartos[2].pareja1
                      ? "font-bold"
                      : ""
                  }`}
                >
              ...
              <div
                ...
                onClick={() => handleClick(cuartos[2].pareja2, "arriba1")}
              >
                <p
                  className={`text-xs text-end p-1 ${
                    parejaSeleccionada1 === cuartos[2].pareja2
                      ? "font-bold"
                      : ""
                  }`}
                >
            ...
            <div className="w-44 h-12 rounded-md border mt-8">
              <div
                className="h-1/2 rounded-t-md cursor-pointer"
                onClick={() => handleClick(cuartos[1].pareja1, "abajo1")}
              >
                <p
                  className={`text-xs text-end p-1 ${
                    parejaSeleccionada2 === cuartos[1].pareja1
                      ? "font-bold"
                      : ""
                  }`}
                >
              ...
              <div
                className="h-1/2 rounded-b-md cursor-pointer"
                onClick={() => handleClick(cuartos[1].pareja2, "abajo1")}
              >
                <p
                  className={`text-xs text-end p-1 ${
                    parejaSeleccionada2 === cuartos[1].pareja2
                      ? "font-bold"
                      : ""
                  }`}
                >
        ...
        <div className="flex mt-12">
          <div className="relative">
            <div className="w-44 h-12 rounded-md border flex flex-col">
              <div
                className="h-1/2 rounded-t-md cursor-pointer"
                onClick={() => handleClick(cuartos[0].pareja1, "arriba2")}
              >
                <p
                  className={`text-xs text-end p-1 ${
                    parejaSeleccionada3 === cuartos[0].pareja1
                      ? "font-bold"
                      : ""
                  }`}
                >
              ...
              <div
                className="h-1/2 rounded-b-md cursor-pointer"
                onClick={() => handleClick(cuartos[0].pareja2, "arriba2")}
              >
                <p
                  className={`text-xs text-end p-1 ${
                    parejaSeleccionada3 === cuartos[0].pareja2
                      ? "font-bold"
                      : ""
                  }`}
                >
            ...
            <div className="w-44 h-12 rounded-md border mt-8">
              <div
                className="h-1/2 rounded-t-md cursor-pointer"
                onClick={() => handleClick(cuartos[3].pareja1, "abajo2")}
              >
                <p
                  className={`text-xs text-end p-1 ${
                    parejaSeleccionada4 === cuartos[3].pareja1
                      ? "font-bold"
                      : ""
                  }`}
                >
              ...
              <div
                className="h-1/2 rounded-b-md cursor-pointer"
                onClick={() => handleClick(cuartos[3].pareja2, "abajo2")}
              >
                <p
                  className={`text-xs text-end p-1 ${
                    parejaSeleccionada4 === cuartos[3].pareja2
                      ? "font-bold"
                      : ""
                  }`}
                >
